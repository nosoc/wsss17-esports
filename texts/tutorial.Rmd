...
View(filter(chat,clusterCut==1)) # communication with stream
View(filter(chat,clusterCut==2)) # reactions on stream
View(filter(chat,clusterCut==3)) # Discussion of action (to some extent)
...
'match_df' object contains chat communication during one particular game: 
