...
We can assume that the most of the chat activity is tightly connected with the game events. Let's try to analyze association of chat communication and game events in one game. We already know how to analyze the association between the cluster and thematic category. Now, please choose one game event and assess the relationship between game event and topics of communication. What is the interpretation of your findings?
...
You have a number of game events. What do some of them mean?
