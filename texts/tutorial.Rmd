...
```{r}
wint_lines = readLines(str_c("/principal/projects/streaming/tlda/", "WordsInTopics.txt"))
cur_topic = 0
...
```{r}
topicsdist = read.table("~/shared/streaming/tlda/TopicsDistributionOnUsers.txt", sep="\t")
...
The number in column of event means its number in the data set. Its is just indicator and does not have much sense in framework of one game.
